...
#define USE_BUTTON_BOX
  ...
  frc2::InstantCommand m_ledFlow{[this] { m_led.SetAnimation(c_colorLightBlue, LEDSubsystem::EAnimation::kFlow);}, {&m_led} };
  frc2::InstantCommand m_ledIdle{[this] { m_led.SetCurrentAction(LEDSubsystem::kIdle);}, {&m_led} };
