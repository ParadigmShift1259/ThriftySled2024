...
//constexpr units::time::second_t   c_EndTriggerDebounce{ 0.04_s };
//constexpr units::time::second_t   c_AlignmentAdjustmentTimeout{ 0.075_s };

AlignToReef::AlignToReef(ISubsystemAccess& subsystemAccess, Pose2d goalPose)
...
#endif
{
    ...
    m_logStartCommand = wpi::log::BooleanLogEntry(log, "/AlignToReef/startCommand");
}
...
void AlignToReef::End(bool interrupted)
{
    ...
    private Command getPathFromWaypoint(Pose2d waypoint) {
        ...
        if (waypoints.get(0).anchor().getDistance(waypoints.get(1).anchor()) < 0.01) {
            ...
            Commands.sequence(
                ...
                AlignToReef.generateCommand(mSwerve, waypoint, kAlignmentAdjustmentTimeout),
